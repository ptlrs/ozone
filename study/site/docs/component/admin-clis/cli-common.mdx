---
slug: /component/admin-clis/cli-common
sidebar_label: "cli-common"
atlasGenerated: true
---
...
_This feature page was generated from `study/atlas/components/admin-clis/cli-common.md`. Author prose belongs above or below the BEGIN/END markers._
...
click GenericParentCommand href "/class/genericparentcommand" "Open GenericParentCommand"
click ExtensibleParentCommand href "/class/extensibleparentcommand" "Open ExtensibleParentCommand"
click AdminSubcommand href "/class/adminsubcommand" "Open AdminSubcommand"
click DebugSubcommand href "/class/debugsubcommand" "Open DebugSubcommand"
click RepairSubcommand href "/class/repairsubcommand" "Open RepairSubcommand"
click GenericCli href "/class/genericcli" "Open GenericCli"
click AbstractSubcommand href "/class/abstractsubcommand" "Open AbstractSubcommand"
click AbstractMixin href "/class/abstractmixin" "Open AbstractMixin"
click DeprecatedCliOption href "/class/deprecatedclioption" "Open DeprecatedCliOption"
click ItemsFromStdin href "/class/itemsfromstdin" "Open ItemsFromStdin"
```
...
|--:|---|---|---|--:|--:|---|
| 2549 | <Fqcn>org.apache.hadoop.hdds.cli.GenericCli</Fqcn> | abstract | mixed | 100~ | 30 | This is a generic parent class for all the ozone related cli tools. |
| 2550 | <Fqcn>org.apache.hadoop.hdds.cli.ItemsFromStdin</Fqcn> | abstract | mixed | 25~ | 30 | Parameter for specifying list of items, reading from stdin if "-" is given as first item. |
| 2551 | <Fqcn>org.apache.hadoop.hdds.cli.AbstractMixin</Fqcn> | abstract | mixed | 25~ | 30 | Base functionality for all Ozone CLI mixins. |
| 2552 | <Fqcn>org.apache.hadoop.hdds.cli.DeprecatedCliOption</Fqcn> | service | mixed | 75~ | 30 | Emits warnings when deprecated CLI option aliases are used and return the recommended replacement option. |
| 2553 | <Fqcn>org.apache.hadoop.hdds.cli.HddsVersionProvider</Fqcn> | service | mixed | 25~ | 30 | Version provider for the CLI interface. |
| 2554 | <Fqcn>org.apache.hadoop.hdds.cli.AbstractSubcommand</Fqcn> | cli | mixed | 50~ | 20 | Base functionality for all Ozone subcommands. |
| 2555 | <Fqcn>org.apache.hadoop.hdds.cli.DebugSubcommand</Fqcn> | cli | mixed | 25~ | 20 | Marker interface for subcommands to be added to OzoneDebug. |
| 2556 | <Fqcn>org.apache.hadoop.hdds.cli.AdminSubcommand</Fqcn> | cli | mixed | 25~ | 20 | Marker interface for subcommands to be added to OzoneAdmin. |
| 2557 | <Fqcn>org.apache.hadoop.hdds.cli.GenericParentCommand</Fqcn> | cli | mixed | 25~ | 20 | Interface to access the higher level parameters. |
| 2558 | <Fqcn>org.apache.hadoop.hdds.cli.RepairSubcommand</Fqcn> | cli | mixed | 25~ | 20 | Marker interface for subcommands to be added to OzoneRepair. |
| 2559 | <Fqcn>org.apache.hadoop.hdds.cli.ExtensibleParentCommand</Fqcn> | cli | mixed | 25~ | 20 | Interface for parent commands that accept subcommands to be dynamically registered. |
...
- [HDDS-14607](https://issues.apache.org/jira/browse/HDDS-14607). Create submodule hdds-cli-common
- [HDDS-7956](https://issues.apache.org/jira/browse/HDDS-7956). Deprecate camelCase and under_score style long options
- [HDDS-7957](https://issues.apache.org/jira/browse/HDDS-7957). Deprecate multi-char short options
- [HDDS-15558](https://issues.apache.org/jira/browse/HDDS-15558). Prevent addition of deprecated style CLI options
- [HDDS-15596](https://issues.apache.org/jira/browse/HDDS-15596). Hide deprecated CLI options
- [HDDS-14578](https://issues.apache.org/jira/browse/HDDS-14578). Ozone admin command gives inconsistent error messages on expired keytab
