---
slug: /component/admin-clis/interactive-shell
...
_This feature page was generated from `study/atlas/components/admin-clis/interactive-shell.md`. Author prose belongs above or below the BEGIN/END markers._
...
|--:|---|---|---|--:|--:|---|
| 2560 | <Fqcn>org.apache.hadoop.ozone.shell.OzoneInteractiveShell</Fqcn> | cli | mixed | 25~ | 30 | Interactive Shell for all Ozone commands. |
...
- [HDDS-11838](https://issues.apache.org/jira/browse/HDDS-11838). Top-level interactive shell to allow access to admin/debug/sh commands
- [HDDS-15185](https://issues.apache.org/jira/browse/HDDS-15185). Create submodule ozone-cli-interactive
- [HDDS-15354](https://issues.apache.org/jira/browse/HDDS-15354). Fix nested tab completion in ozone interactive
- [HDDS-15368](https://issues.apache.org/jira/browse/HDDS-15368). Remove static horizontal divider from ozone interactive shell
...
Answer 5: [HDDS-11838](https://issues.apache.org/jira/browse/HDDS-11838) introduced the top-level interactive shell. [HDDS-15185](https://issues.apache.org/jira/browse/HDDS-15185) moved it into its own submodule `ozone-cli-interactive`.
