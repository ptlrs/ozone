---
slug: /component/hddscommon/metrics-utils
sidebar_label: "metrics-utils"
atlasGenerated: true
---
...
_This feature page was generated from `study/atlas/components/hddscommon/metrics-utils.md`. Author prose belongs above or below the BEGIN/END markers._
...
|--:|---|---|---|--:|--:|---|
| 1960 | <Fqcn>org.apache.hadoop.ozone.grpc.metrics.GrpcMetrics</Fqcn> | metrics | mixed | 125~ | 20 | Class which maintains metrics related to using GRPC. |
| 1961 | <Fqcn>org.apache.hadoop.ozone.grpc.metrics.GrpcMetricsServerRequestInterceptor</Fqcn> | metrics | mixed | 50~ | 20 | Interceptor to gather metrics based on grpc server request. |
| 1962 | <Fqcn>org.apache.hadoop.ozone.grpc.metrics.GrpcMetricsServerResponseInterceptor</Fqcn> | metrics | mixed | 25~ | 20 | Interceptor to gather metrics based on grpc server response. |
| 1963 | <Fqcn>org.apache.hadoop.ozone.grpc.metrics.GrpcMetricsServerTransportFilter</Fqcn> | metrics | mixed | 25~ | 20 | Transport filter class for tracking active client connections. |
...
- [HDDS-12640](https://issues.apache.org/jira/browse/HDDS-12640). Move GrpcMetrics to hdds-server-framework
- [HDDS-12880](https://issues.apache.org/jira/browse/HDDS-12880). Move field declarations to start of class in hdds-server-framework
- [HDDS-6631](https://issues.apache.org/jira/browse/HDDS-6631). Fix typos in output/exception messages
...
- [`http-server.md`](/component/hddscommon/http-server) — `PrometheusServlet` scrapes the Metrics2 system that `GrpcMetrics` registers with
- [`tracing-common.md`](/component/hddscommon/tracing-common) — OpenTelemetry tracing that decorates the same gRPC interceptor chain
- [`framework-server.md`](/component/hddscommon/framework-server) — shared server framework in the same module
- [`framework-protocol.md`](/component/hddscommon/framework-protocol) — gRPC protocol definitions for the services these metrics instrument
