---
slug: /component/dn/dn-upgrade
sidebar_label: "dn-upgrade"
atlasGenerated: true
---
...
_This feature page was generated from `study/atlas/components/dn/dn-upgrade.md`. Author prose belongs above or below the BEGIN/END markers._
...
|--:|---|---|---|--:|--:|---|
| 1595 | <Fqcn>org.apache.hadoop.ozone.container.upgrade.VersionedDatanodeFeatures</Fqcn> | service | mixed | 75~ | 30 | Utility class to retrieve the version of a feature that corresponds to the metadata layout version specified by the p... |
| 1596 | <Fqcn>org.apache.hadoop.ozone.container.upgrade.ScmHAFinalizeUpgradeActionDatanode</Fqcn> | service | mixed | 75~ | 30 | Action to run upgrade flow for SCM HA exactly once. |
| 1597 | <Fqcn>org.apache.hadoop.ozone.container.upgrade.DataNodeUpgradeFinalizer</Fqcn> | service | mixed | 50~ | 30 | UpgradeFinalizer for the DataNode. |
| 1598 | <Fqcn>org.apache.hadoop.ozone.container.upgrade.ContainerTableSchemaFinalizeAction</Fqcn> | service | mixed | 50~ | 30 | Upgrade Action for DataNode for update the table schema data of containerIds Table. |
| 1599 | <Fqcn>org.apache.hadoop.ozone.container.upgrade.DatanodeSchemaV3FinalizeAction</Fqcn> | service | mixed | 25~ | 30 | Upgrade Action for DataNode for SCHEMA V3. |
| 1600 | <Fqcn>org.apache.hadoop.ozone.container.upgrade.DatanodeSchemaV2FinalizeAction</Fqcn> | service | mixed | 25~ | 30 | Upgrade Action for DataNode for the very first first Upgrade Version. |
| 1601 | <Fqcn>org.apache.hadoop.ozone.container.upgrade.UpgradeUtils</Fqcn> | service | mixed | 25~ | 30 | Util methods for upgrade. |
...
- [HDDS-6597](https://issues.apache.org/jira/browse/HDDS-6597). Non-rolling upgrade supports container schema v3 (`DatanodeSchemaV3FinalizeAction` introduced).
- [HDDS-6760](https://issues.apache.org/jira/browse/HDDS-6760). SCM HA finalization: happy path (`ScmHAFinalizeUpgradeActionDatanode` introduced).
...
- [HDDS-13176](https://issues.apache.org/jira/browse/HDDS-13176). `containerIds` table value format changed to proto (`ContainerTableSchemaFinalizeAction`).
