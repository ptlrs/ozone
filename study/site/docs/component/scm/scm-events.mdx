---
slug: /component/scm/scm-events
sidebar_label: "scm-events"
atlasGenerated: true
---
...
_This feature page was generated from `study/atlas/components/scm/scm-events.md`. Author prose belongs above or below the BEGIN/END markers._
...
click SCMEvents href "/class/scmevents" "Open SCMEvents"
```
...
|--:|---|---|---|--:|--:|---|
| 1476 | <Fqcn>org.apache.hadoop.hdds.scm.events.SCMEvents</Fqcn> | service | mixed | 75~ | 30 | Class that acts as the namespace for all SCM Events. |
...
- [HDDS-8660](https://issues.apache.org/jira/browse/HDDS-8660). Notify ReplicationManager when nodes go dead or out of service — added `DEAD_NODE` consumers.
- [HDDS-13980](https://issues.apache.org/jira/browse/HDDS-13980). SCM start DN protocol server during startup — touches event wiring at startup.
