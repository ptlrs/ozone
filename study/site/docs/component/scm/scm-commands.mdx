---
slug: /component/scm/scm-commands
sidebar_label: "scm-commands"
atlasGenerated: true
---
...
_This feature page was generated from `study/atlas/components/scm/scm-commands.md`. Author prose belongs above or below the BEGIN/END markers._
...
|--:|---|---|---|--:|--:|---|
| 1475 | <Fqcn>org.apache.hadoop.hdds.scm.command.CommandStatusReportHandler</Fqcn> | service | mixed | 50~ | 30 | Handles CommandStatusReports from datanode. |
...
- [HDDS-325](https://issues.apache.org/jira/browse/HDDS-325). Add event watcher for delete blocks command — introduced the command-status report feedback loop.
