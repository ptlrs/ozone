---
slug: /component/scm/pipeline-choose-policy
sidebar_label: "pipeline-choose-policy"
atlasGenerated: true
---
...
_This feature page was generated from `study/atlas/components/scm/pipeline-choose-policy.md`. Author prose belongs above or below the BEGIN/END markers._
...
click PipelineChoosePolicy href "/class/pipelinechoosepolicy" "Open PipelineChoosePolicy"
click RandomPipelineChoosePolicy href "/class/randompipelinechoosepolicy" "Open RandomPipelineChoosePolicy"
click RoundRobinPipelineChoosePolicy href "/class/roundrobinpipelinechoosepolicy" "Open RoundRobinPipelineChoosePolicy"
click HealthyPipelineChoosePolicy href "/class/healthypipelinechoosepolicy" "Open HealthyPipelineChoosePolicy"
click CapacityPipelineChoosePolicy href "/class/capacitypipelinechoosepolicy" "Open CapacityPipelineChoosePolicy"
click PipelineChoosePolicyFactory href "/class/pipelinechoosepolicyfactory" "Open PipelineChoosePolicyFactory"
```
...
|--:|---|---|---|--:|--:|---|
| 568 | <Fqcn>org.apache.hadoop.hdds.scm.pipeline.choose.algorithms.CapacityPipelineChoosePolicy</Fqcn> | service | mixed | 75~ | 30 | Pipeline choose policy that randomly choose pipeline with relatively lower utilization. |
| 569 | <Fqcn>org.apache.hadoop.hdds.scm.pipeline.choose.algorithms.HealthyPipelineChoosePolicy</Fqcn> | service | mixed | 25~ | 30 | The healthy pipeline choose policy that chooses pipeline until return healthy pipeline. |
| 570 | <Fqcn>org.apache.hadoop.hdds.scm.pipeline.choose.algorithms.RoundRobinPipelineChoosePolicy</Fqcn> | service | mixed | 25~ | 30 | Round-robin choose policy that chooses pipeline in a round-robin fashion. |
| 571 | <Fqcn>org.apache.hadoop.hdds.scm.pipeline.choose.algorithms.RandomPipelineChoosePolicy</Fqcn> | service | mixed | 25~ | 30 | Random choose policy that randomly chooses pipeline. |
| 572 | <Fqcn>org.apache.hadoop.hdds.scm.pipeline.choose.algorithms.PipelineChoosePolicyFactory</Fqcn> | factory | mixed | 75~ | 20 | A factory to create pipeline choose policy instance based on configuration property ScmConfig. |
