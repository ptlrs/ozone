---
slug: /component/recon/recon-security
sidebar_label: "recon-security"
atlasGenerated: true
---
...
_This feature page was generated from `study/atlas/components/recon/recon-security.md`. Author prose belongs above or below the BEGIN/END markers._
...
click ReconCertificateClient href "/class/reconcertificateclient" "Open ReconCertificateClient"
click CredentialHelper href "/class/credentialhelper" "Open CredentialHelper"
click DefaultCertificateClient href "/class/defaultcertificateclient" "Open DefaultCertificateClient"
```
...
|--:|---|---|---|--:|--:|---|
| 2402 | <Fqcn>org.apache.hadoop.ozone.recon.chatbot.security.CredentialHelper</Fqcn> | service | mixed | 25~ | 30 | Centralised utility for reading secrets from the Hadoop Credential Provider (JCEKS). |

### Sub-feature: `recon.security`

| reading_order | fqcn | kind | logic | loc | study (min) | role |
|--:|---|---|---|--:|--:|---|
| 2403 | <Fqcn>org.apache.hadoop.ozone.recon.security.ReconCertificateClient</Fqcn> | service | mixed | 50~ | 30 | Certificate client for Recon. |
...
- [HDDS-8030](https://issues.apache.org/jira/browse/HDDS-8030). Cleanup unused/unnecessary code related to CertificateClient
- [HDDS-8879](https://issues.apache.org/jira/browse/HDDS-8879). Cleanup SecurityConfig and related class initialization
- [HDDS-9334](https://issues.apache.org/jira/browse/HDDS-9334). Improve thread names in common/framework
- [HDDS-9418](https://issues.apache.org/jira/browse/HDDS-9418). Consolidate CertificateClient handleCase handling
- [HDDS-11028](https://issues.apache.org/jira/browse/HDDS-11028). Replace PKCS10CertificationRequest usage in CertificateClient
- [HDDS-14816](https://issues.apache.org/jira/browse/HDDS-14816). Add Recon AI Assistant backend foundation with Multi LLM integration (introduced CredentialHelper)
