---
slug: /component/om/om-bucket-manager
sidebar_label: "om-bucket-manager"
atlasGenerated: true
---
...
_This feature page was generated from `study/atlas/components/om/om-bucket-manager.md`. Author prose belongs above or below the BEGIN/END markers._
...
click BucketManager href "/class/bucketmanager" "Open BucketManager"
click BucketManagerImpl href "/class/bucketmanagerimpl" "Open BucketManagerImpl"
```
...
|--:|---|---|---|--:|--:|---|
| 481 | <Fqcn>org.apache.hadoop.ozone.om.BucketManager</Fqcn> | interface | mixed | 25~ | 20 | BucketManager handles all the bucket level operations. |
| 482 | <Fqcn>org.apache.hadoop.ozone.om.BucketManagerImpl</Fqcn> | service | mixed | 125~ | 30 | Implementation for BucketManager BucketManager uses MetadataDB to store bucket level information. |
...
3. `OmBucketInfo.getAcls()` returns an immutable list after [HDDS-14111](https://issues.apache.org/jira/browse/HDDS-14111). Why was this change made?
