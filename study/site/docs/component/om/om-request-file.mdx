---
slug: /component/om/om-request-file
sidebar_label: "om-request-file"
atlasGenerated: true
---
...
_This feature page was generated from `study/atlas/components/om/om-request-file.md`. Author prose belongs above or below the BEGIN/END markers._
...
click OMFileRequest href "/class/omfilerequest" "Open OMFileRequest"
click OMFileCreateRequestWithFSO href "/class/omfilecreaterequestwithfso" "Open OMFileCreateRequestWithFSO"
click OMDirectoryCreateRequestWithFSO href "/class/omdirectorycreaterequestwithfso" "Open OMDirectoryCreateRequestWithFSO"
click OMFileCreateRequest href "/class/omfilecreaterequest" "Open OMFileCreateRequest"
click OMDirectoryCreateRequest href "/class/omdirectorycreaterequest" "Open OMDirectoryCreateRequest"
click OMRecoverLeaseRequest href "/class/omrecoverleaserequest" "Open OMRecoverLeaseRequest"
```
...
|--:|---|---|---|--:|--:|---|
| 1436 | <Fqcn>org.apache.hadoop.ozone.om.request.file.OMFileCreateRequestWithFSO</Fqcn> | service | mixed | 150~ | 45 | Handles create file request layout version1. |
| 1437 | <Fqcn>org.apache.hadoop.ozone.om.request.file.OMDirectoryCreateRequestWithFSO</Fqcn> | service | mixed | 125~ | 30 | Handle create directory request. |
| 1438 | <Fqcn>org.apache.hadoop.ozone.om.request.file.OMFileRequest</Fqcn> | dto | logic-heavy | 600~ | 10 | Base class for file requests. |
| 1439 | <Fqcn>org.apache.hadoop.ozone.om.request.file.OMFileCreateRequest</Fqcn> | dto | logic-heavy | 250~ | 10 | Handles create file request. |
| 1440 | <Fqcn>org.apache.hadoop.ozone.om.request.file.OMDirectoryCreateRequest</Fqcn> | dto | logic-heavy | 200~ | 10 | Handle create directory request. |
| 1441 | <Fqcn>org.apache.hadoop.ozone.om.request.file.OMRecoverLeaseRequest</Fqcn> | dto | data-only | 175~ | 10 | Perform actions for RecoverLease requests. |
...
- [HDDS-14957](https://issues.apache.org/jira/browse/HDDS-14957). Separate OpenKeyInfo to differentiate KeyInfo (affects `OMFileCreateRequestWithFSO`)
- [HDDS-15803](https://issues.apache.org/jira/browse/HDDS-15803). Fix parameter number warning in OMKeyRequest.allocateBlock (affects file creation allocate path)
