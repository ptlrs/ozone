...
|--:|---|---|---|--:|--:|---|
| 1535 | `org.apache.hadoop.ozone.protocol.StorageContainerNodeProtocol` | interface | mixed | 25~ | 20 | The protocol spoken between datanodes and SCM. |
| 1536 | `org.apache.hadoop.ozone.protocol.ReconDatanodeProtocol` | interface | mixed | 25~ | 20 | The protocol spoken between datanodes and Recon. |
| 1537 | `org.apache.hadoop.ozone.protocol.StorageContainerDatanodeProtocol` | interface | mixed | 25~ | 20 | The protocol spoken between datanodes and SCM. |
| 1538 | `org.apache.hadoop.ozone.protocol.VersionResponse` | dto | data-only | 75~ | 10 | Version response class. |

### Sub-feature: `ozone.protocolPB`

| reading_order | fqcn | kind | logic | loc | study (min) | role |
|--:|---|---|---|--:|--:|---|
| 1539 | `org.apache.hadoop.ozone.protocolPB.StorageContainerDatanodeProtocolClientSideTranslatorPB` | service | mixed | 75~ | 20 | This class is the client-side translator to translate the requests made on the StorageContainerDatanodeProtocol inter... |
| 1540 | `org.apache.hadoop.ozone.protocolPB.StorageContainerDatanodeProtocolServerSideTranslatorPB` | rpc-stub | data-only | 75~ | 20 | This class is the server-side translator that forwards requests received on StorageContainerDatanodeProtocolPB to the... |
| 1541 | `org.apache.hadoop.ozone.protocolPB.StorageContainerDatanodeProtocolPB` | rpc-stub | data-only | 25~ | 20 | Protocol used from a datanode to StorageContainerManager. |
| 1542 | `org.apache.hadoop.ozone.protocolPB.ReconDatanodeProtocolPB` | rpc-stub | data-only | 25~ | 20 | Protocol used from a datanode to Recon. |
...
- HDDS-13086. Block duplicate reconciliation requests within the datanode (uses `StorageContainerDatanodeProtocol`).
- HDDS-02f90379. Use forked Hadoop RPC (HDDS-13753) — migrated these translators to the forked RPC stack.
- HDDS-5267. Full Container Report can remove replicas added by an Incremental Report (uses `sendHeartbeat`).
