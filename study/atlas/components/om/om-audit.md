...
|--:|---|---|---|--:|--:|---|
| 1426 | `org.apache.hadoop.ozone.audit.OMAction` | data | data-only | 100~ | 10 | Enum to define Audit Action types for OzoneManager. |
| 1427 | `org.apache.hadoop.ozone.audit.OMSystemAction` | data | data-only | 25~ | 10 | Enum to define Audit Action types for system audit in OzoneManager. |
...
- HDDS-8203. Log OM Garbage Collection logs to an OM System audit log file (OMSystemAction)
...
Answer 5: `OMSystemAction` events are written to a separate OM system audit log file (HDDS-8203); `OMAction` events go to the regular OM audit log.
