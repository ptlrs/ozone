...
|--:|---|---|---|--:|--:|---|
| 1469 | `org.apache.hadoop.ozone.om.request.upgrade.OMPrepareRequest` | dto | data-only | 150~ | 10 | OM Request used to flush all transactions to disk, take a DB snapshot, and purge the logs, leaving Ratis in a clean s... |
| 1470 | `org.apache.hadoop.ozone.om.request.upgrade.OMCancelPrepareRequest` | dto | data-only | 50~ | 10 | OM request class to cancel preparation. |
| 1471 | `org.apache.hadoop.ozone.om.request.upgrade.OMFinalizeUpgradeRequest` | dto | data-only | 50~ | 10 | Handles finalizeUpgrade request. |
...
- HDDS-14347. Handle upgrades to support S3 lifecycle (OMFinalizeUpgradeRequest used for lifecycle)
