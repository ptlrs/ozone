...
public final class HddsConfigKeys {
  ...
  public static final String HDDS_CONTAINER_EXPORT_TMPDIR =
      "hdds.container.export.tmpdir";

  public static final String HDDS_CONTAINER_EXPORT_TMPDIR_DEFAULT = "/tmp";
